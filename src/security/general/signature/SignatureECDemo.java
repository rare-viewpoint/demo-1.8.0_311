 ...
 * @Date 2021/12/5 5:13
 */
public class SignatureECDemo {

    private final static String SIGNATURE_ALGORITHM = "SHA1withECDSA";
    private final static String KEY_PAIR_ALGORITHM = "EC";

    static KeyPair getKeyPair() throws NoSuchAlgorithmException {
        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance(KEY_PAIR_ALGORITHM);
        keyPairGenerator.initialize(112); //112 ~ 571

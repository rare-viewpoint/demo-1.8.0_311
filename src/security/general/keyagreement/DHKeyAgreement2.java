...
public class DHKeyAgreement2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Alice creates and initializes her DH KeyAgreement io.object
        ...
        System.out.println(aliceKpair.getPublic().getFormat());
        ...
        // Bob creates and initializes his DH KeyAgreement io.object
        ...
        /*
         * Now let's create a SecretKey io.object using the shared secret
         ...
         * io.object for encryption, the underlying implementation will generate
         * a random one, which you have to retrieve using the
         * javax.crypto.Cipher.getParameters() method, which returns an
         * instance of java.security.AlgorithmParameters. You need to transfer
         * the contents of that io.object (e.g., in encoded format, obtained via
         * the AlgorithmParameters.getEncoded() method) to the party who will
         * do the decryption. When initializing the Cipher for decryption,
         * the (reinstantiated) AlgorithmParameters io.object must be explicitly
         * passed to the Cipher.init() method.
         */
        System.out.println("Use shared secret as SecretKey io.object ...");
        ...
        // Instantiate AlgorithmParameters io.object from parameter encoding
        // obtained from Bob
